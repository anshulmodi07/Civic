    ...
    try {
      ...
      const detail =
        message === "Network Error"
          ? `Could not reach ${API_BASE}. Confirm the backend is running and reachable from this device.`
          : message;
            ...
            <View style={styles.formCard}>
              ...
              <View style={styles.segmentedControl}>
                ...
                >
                  ...
                  />
                  <Text style={[styles.segmentText, loginType === "user" && styles.segmentTextActive]}>
                    User
                  </Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  />
                  <Text style={[styles.segmentText, loginType === "worker" && styles.segmentTextActive]}>
                    Worker
                  </Text>
                </TouchableOpacity>
              </View>
