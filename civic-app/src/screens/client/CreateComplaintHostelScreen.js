...
export default function CreateComplaintHostelScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          <Text style={styles.label}>
            <Ionicons name="door-open" size={16} color="#334155" /> Room Number *
          </Text>
          <View style={styles.inputWrapper}>
            <TextInput
              value={roomNumber}
...
const styles = StyleSheet.create({
  ...
  textArea: { padding: 16, fontSize: 16, color: "#1e293b", fontWeight: "500", minHeight: 140 },
