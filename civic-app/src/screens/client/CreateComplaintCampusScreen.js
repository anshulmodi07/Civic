...
import {
  ...
  getErrorMessages,
  hasErrorIssues,
} from "../../services/complaintValidation.service";
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.pickerWrapper}>
            <RNPickerSelect
              onValueChange={(value) => setLocationLandmark(value)}
        ...
        <View style={styles.section}>
          <Text style={styles.label}>
            <Ionicons name="map" size={16} color="#334155" /> Address or Additional Details *
          </Text>
        ...
        <View style={styles.section}>
          <Text style={styles.label}>
            <Ionicons name="satellite" size={16} color="#334155" /> GPS Location *
          </Text>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.imageActions}>
            <TouchableOpacity style={styles.imageActionButton} onPress={takePhoto} activeOpacity={0.7}>
              <Ionicons name="camera" size={24} color="#2563eb" />
              <Text style={styles.imageActionText}>Take Photo</Text>
            </TouchableOpacity>

            <TouchableOpacity style={styles.imageActionButton} onPress={pickImage} activeOpacity={0.7}>
...
const styles = StyleSheet.create({
  ...
  textArea: { padding: 16, fontSize: 16, color: "#1e293b", fontWeight: "500", minHeight: 100 },
  charCount: { fontSize: 12, color: "#94a3b8", marginTop: 6, textAlign: "right", fontWeight: "500" },
  locationCard: {
    flexDirection: "row",
    alignItems: "center",
    backgroundColor: "#fff",
  ...
  locationLoading: { flexDirection: "row", alignItems: "center", flex: 1 },
  locationLoadingText: { marginLeft: 12, fontSize: 14, color: "#64748b", fontWeight: "500" },
  locationInfo: { flex: 1, marginLeft: 12 },
  locationTitle: { fontSize: 16, fontWeight: "600", color: "#1e293b", marginBottom: 2 },
  locationCoords: { fontSize: 13, color: "#64748b", fontFamily: "monospace" },
  locationError: { fontSize: 13, color: "#ef4444", fontWeight: "500" },
...
const pickerSelectStyles = {
  ...
  iconContainer: { top: "50%", marginTop: -10, right: 16 },
  placeholder: { color: "#94a3b8", fontSize: 16, fontWeight: "500" },
};
